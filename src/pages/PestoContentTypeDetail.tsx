...
export const PestoContentTypeDetail: FunctionalComponent<PestoContentTypeDetailProps> = ({ project_id }: PestoContentTypeDetailProps): JSX.Element => {
  console.log(`[PestoContentTypeDetail] - project_id: `, project_id)
